...
def main():
    ...
    cluster_train_labels = np.loadtxt('./data/cluster_for_train_labels_cifar100_1500.txt', dtype=int)
    cluster_aug_labels = np.loadtxt('./data/cluster_for_aug_labels_cifar100_505.txt', dtype=int)
    ...
    cluster_list = [cluster_train_labels1, cluster_train_labels2,cluster_train_labels3, cluster_aug_labels1, cluster_aug_labels2,cluster_aug_labels3]
