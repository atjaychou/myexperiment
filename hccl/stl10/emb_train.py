...
def get_data_loaders(dataset_name, target_size=96):
    ...
    if dataset_name == 'cifar10':
        ...
        # CIFAR-100 dataset
        train_dataset = datasets.STL10(root=data_dir, split='train', download=True, transform=data_augmentation)
...
def main():
    ...
    cluster_train_labels = np.loadtxt('./data/cluster_labels_cifar100_505.txt', dtype=int)
