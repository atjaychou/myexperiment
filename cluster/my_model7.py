...
def my_loss(train_features, augmented_features, cluster_labels, batch_index, temperature):
...
def train(model, train_loader, augmented_train_loader, cluster_labels, learning_rate,
    ...
    for epoch in range(num_epochs):
        ...
        for batch_index, (train_data, augmented_train_data) in enumerate(zip(train_loader, augmented_train_loader)):
            ...
            optimizer.zero_grad()
            loss = my_loss(train_features, augmented_features, cluster_labels, batch_index, temperature).to(device)
